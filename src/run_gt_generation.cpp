...
DEFINE_string(gt_cloud, "",
              "Full file path to ground truth cloud (pcd) used to register scans against. ");
DEFINE_validator(gt_cloud, &beam::gflags::ValidateFileMustExist);
DEFINE_string(gt_cloud_pose, "",
              "Full file path to the ground truth cloud pose (json). This transform from the "
              "GT cloud's frame to the world frame (T_World_GtCloud), or the fixed frame in "
              "the initial poses. This can be generated by aligning the GT Cloud to a map "
              "generated with the intial estimated poses. This can be done easily in "
              "CloudCompare. See example file: T_World_GtCloud_example.json");
...
int main(int argc, char *argv[])
{
  ...
  ScanPoseGtGeneration::Inputs inputs;
